...
import ${tablePd.pack_path}.module.common.base.controller.BaseController;
import ${tablePd.pack_path}.module.common.base.entity.QueryRequest;
import ${tablePd.pack_path}.module.common.framework.exception.BizException;
import ${tablePd.pack_path}.${tablePd.mod_name}.entity.${tablePd.bus_name?cap_first};
import ${tablePd.pack_path}.system.entity.UserOrganize;
import ${tablePd.pack_path}.${tablePd.mod_name}.service.I${tablePd.bus_name?cap_first}Service;
import ${tablePd.pack_path}.system.service.IUserOrganizeService;
import ${tablePd.pack_path}.system.service.IUserService;
import ${tablePd.pack_path}.module.common.utils.*;
...
public class ${tablePd.bus_name?cap_first}Controller extends BaseController {
    ...
    public Map<String, Object> listPage(QueryRequest queryRequest, ${tablePd.bus_name?cap_first} ${tablePd.bus_name}) {
