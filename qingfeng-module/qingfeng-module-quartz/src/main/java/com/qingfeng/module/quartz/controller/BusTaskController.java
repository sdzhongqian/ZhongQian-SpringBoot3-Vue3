package com.qingfeng.module.quartz.controller;
...
import com.qingfeng.module.quartz.entity.QuartzEntity;
...
public class BusTaskController extends BaseController {
	...
	public Map<String, Object> listPage(QueryRequest queryRequest, Bustask bustask) {
	...
	public void save(@Valid @RequestBody Bustask bustask,HttpServletResponse response) throws Exception {
		...
		try {
			...
			bustask.setJob_class_name("com.qingfeng.module.quartz.job.MessageJob");
