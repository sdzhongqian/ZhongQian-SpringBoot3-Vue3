package com.qingfeng.framework.security.utils;
...
public class JwtUtil {
     ...
     * @return 令牌
     */
    public String createJWT(UserDetails details, String id, String username,String organize_id){
        ...
        return JWT.create()
                ...
                .withClaim("organize_id", organize_id)
    ...
    public UserDetails toUser(DecodedJWT decodedJWT){
        ...
        return User
                .withUsername(claims.get("name").asString()+":"+claims.get("id").asString()+":"+claims.get("organize_id").asString())
